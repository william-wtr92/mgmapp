...
export const addUserValidationSchema = yup.object().shape({
  ...
  password: yup.string().required("Veuillez remplir le champ").min(3, "Veuillez remplir le champ"),
  ...
  roleId: yup.number().required("Veuillez remplir le champ").min(0, "Veuillez remplir le champ correctement"),
})
